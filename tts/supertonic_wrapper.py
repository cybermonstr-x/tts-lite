...
class SupertonicEngine(TTSEngine):
    ...
    VOICES = [
        VoiceInfo(
            id="M1", name="M1 — Мужской (четкий)", language="ru/en", gender="male"
        ),
        VoiceInfo(
            id="M2", name="M2 — Мужской (спокойный)", language="ru/en", gender="male"
        ),
        VoiceInfo(
            id="M3", name="M3 — Мужской (энергичный)", language="ru/en", gender="male"
        ),
        VoiceInfo(
            id="M4", name="M4 — Мужской (глубокий)", language="ru/en", gender="male"
        ),
        VoiceInfo(
            id="M5", name="M5 — Мужской (мягкий)", language="ru/en", gender="male"
        ),
        VoiceInfo(
            id="F1", name="F1 — Женский (чёткий)", language="ru/en", gender="female"
        ),
        VoiceInfo(
            id="F2", name="F2 — Женский (спокойный)", language="ru/en", gender="female"
        ),
        VoiceInfo(
            id="F3", name="F3 — Женский (энергичный)", language="ru/en", gender="female"
        ),
        VoiceInfo(
            id="F4", name="F4 — Женский (глубокий)", language="ru/en", gender="female"
        ),
        VoiceInfo(
            id="F5", name="F5 — Женский (мягкий)", language="ru/en", gender="female"
        ),
    ]
