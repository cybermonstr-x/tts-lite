...
def split_into_sentences(text: str) -> List[str]:
    ...
    # Simple approach: split on sentence endings followed by space and capital letter
    # This handles most cases without complex lookbehind
...
def calculate_word_timings(sentence: str, duration: float) -> List[Tuple[str, float, float]]:
    ...
    if total_length == 0:
        ...
        return [(word, i * word_duration, (i + 1) * word_duration) for i, word in enumerate(words)]
